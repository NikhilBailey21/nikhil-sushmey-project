...
def create_app(test_config=None):
    ...
    # make url_for('index') == url_for('transactionAnalyzer.index')
    # in another app, you might define a separate main index here with
    # app.route, while giving the transactionAnalyzer blueprint a url_prefix, but for
    # the tutorial the transactionAnalyzer will be the main index
